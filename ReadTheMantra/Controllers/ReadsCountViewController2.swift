...
class ReadsCountViewController2: UIViewController {
    ...
    private func setReadsButtonsTitles() {
        ...
        let largeReadings = UIImage(systemName: "plus.circle", withConfiguration: largeConfig)?.withTintColor(.systemBackground, renderingMode: .alwaysOriginal)
        let largeRounds = UIImage(systemName: "goforward.plus", withConfiguration: largeConfig)?.withTintColor(.systemBackground, renderingMode: .alwaysOriginal)
        let largeHand = UIImage(systemName: "hand.draw", withConfiguration: largeConfig)?.withTintColor(.systemBackground, renderingMode: .alwaysOriginal)
        ...
        addRoundsButton.layer.cornerRadius = 40
        addReadingsButton.layer.cornerRadius = 40
        setProperValueButton.layer.cornerRadius = 40
    }
...
extension ReadsCountViewController2: DetailsViewControllerDelegate {
...
extension ReadsCountViewController2 {
