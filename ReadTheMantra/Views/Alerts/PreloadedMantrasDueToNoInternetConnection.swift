...
extension UIAlertController {
    ...
    static func preloadedMantrasDueToNoInternetConnection() -> UIAlertController {
        let alert = UIAlertController(
            ...
            message: NSLocalizedString("It seems like there is no internet connection right now. New set of mantras was preloaded. If you were using 'Mantra Reader' previously with enebled iCloud account, your recordings will be added to list automatically, when internet connection will be available.",
